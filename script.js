document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      const errorId = field.id ? 'error-' + field.id : null;
      if (errorId) {
    ...
    function showError(field, message) {
      ...
      const errorId = field.id ? 'error-' + field.id : 'error-' + Math.random().toString(36).slice(2);
    ...
    function validateField(field) {
      ...
      if (dataset.minLength) {
        if (!VALIDATION_RULES.minLength(value, dataset.minLength)) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Get Global Yield משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ca7454ec-2b6b-481b-b22d-331103a0cf42',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ca7454ec-2b6b-481b-b22d-331103a0cf42';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ca7454ec-2b6b-481b-b22d-331103a0cf42';
